...
export * from './lib/interfaces/filemanager-notification.interface';
export * from './lib/interfaces/filemanager-translation.interface';
...
export * from './lib/services/FilemanagerNotifications';
...
export {INotification} from './lib/interfaces/filemanager-notification.interface';
