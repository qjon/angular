...
describe('fileManagerBackendApi.service', () => {
  ...
  beforeEach(() => {
    ...
    httpMock = jasmine.createSpyObj<HttpClient>('Http', ['delete', 'get', 'post', 'put']);
  ...
  describe('load', () => {
    it('should load all nodes from given node', function () {
      httpMock.get.and.returnValue(of([rootNode]));
  ...
  describe('add', () => {
    ...
    beforeEach(() => {
      ...
      httpMock.post.and.returnValue(of(createdNode));
  ...
  describe('move', () => {
    ...
    beforeEach(() => {
      ...
      httpMock.get.and.returnValue(of([srcNode]));
      httpMock.put.and.returnValue(of(movedNode));
  ...
  describe('update', () => {
    ...
    beforeEach(() => {
      ...
      httpMock.get.and.returnValue(of([node]));
      httpMock.put.and.returnValue(of(updatedNode));
  ...
  describe('remove', () => {
    ...
    beforeEach(() => {
      ...
      httpMock.get.and.returnValue(of([node]));
      httpMock.delete.and.returnValue(of(removedNode));
  ...
  describe('cropFile', () => {
    ...
    beforeEach(() => {
      ...
      httpMock.put.and.returnValue(of(file));
